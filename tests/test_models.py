...
class ModelsTest(unittest.TestCase):
    ...
    def test_create_account_from_dict(self):
        ...
        account = Account.from_dict(self.sut, data)
        self.assertTrue(isinstance(account, Account))
    
    def test_create_bank_contact_from_dict(self):
        data = {"bank_id": "B1.1",
                "sepa_creditor_id": "DE67900900424711951500",
                "save_pin": True}
        bank_contact = BankContact.from_dict(self.sut, data)
        self.assertTrue(isinstance(bank_contact, BankContact))
    
    def test_create_accountbalance_from_dict(self):
        data = {
                "balance": 3250.30, 
                "balance_date": "2013-09-11T00:00:00.000Z", 
                "credit_line": 0.0, 
        ...
        account_balance = AccountBalance.from_dict(self.sut, data)
        self.assertTrue(isinstance(account_balance, AccountBalance))
    
    def test_create_payment_from_dict(self):
        data = {
                "account_id": "A1.1", 
        ...
        payment = Payment.from_dict(self.sut, data)
        self.assertTrue(isinstance(payment, Payment))
    
    def test_create_transaction_from_dict(self):
        data = {
                "account_id": "A1.1", 
                "account_number": "4711951501", 
                "amount": -17.89, 
        ...
        transaction = Transaction.from_dict(self.sut, data)
    ...
    def test_create_sync_status_from_dict(self):
        data = {
                "code": -1, 
                "message": "Cannot load credential 8f084858-e1c6-4642-87f8-540b530b6e0f: UUID does not exist.", 
                "success_timestamp": "2013-09-11T00:00:00.000Z", 
        ...
        sync_status = SynchronizationStatus.from_dict(self.sut, data)
        self.assertTrue(isinstance(sync_status, SynchronizationStatus))
    ...
    def test_create_user_from_dict(self):
        ...
        user = User.from_dict(self.sut, data)
        self.assertTrue(isinstance(user, User))
    
    def test_create_webhook_notification_from_dict(self):
        pass
    ...
    def test_create_login_settings_from_dict(self):
        data = {
                "additional_icons": {
                                     "48x48": "https://api.figo.me/assets/images/accounts/default-small@2x.png", 
                                     "60x60": "https://api.figo.me/assets/images/accounts/default@2x.png"
        ...
        login_settings = LoginSettings.from_dict(self.sut, data)
        self.assertTrue(isinstance(login_settings, LoginSettings))
    
    def test_create_credential_from_dict(self):
        data = {
            "label": "Benutzername"
            }
        credential = Credential.from_dict(self.sut, data)
        self.assertTrue(isinstance(credential, Credential))
    
    def test_create_task_token_from_dict(self):
        data = {
                "task_token": "YmB-BtvbWufLnbwgAVfP7XfLatwhrtu0sATfnZNR7LGP-aLXiZ7BKzLdZI--EqEPnwh_h6mCxToLEBhtA7LVd4uM4gTcZG8F6UJs47g6kWJ0"
                }
        task_token = TaskToken.from_dict(self.sut, data)
        self.assertTrue(isinstance(task_token, TaskToken))
    
    def test_create_task_state_from_dict(self):
        data = {
                "account_id": "A1.2", 
                "is_ended": False, 
                "is_erroneous": False, 
        ...
        task_state = TaskState.from_dict(self.sut, data)
        self.assertTrue(isinstance(task_state, TaskState))
    
    def test_create_challenge_from_dict(self):
        data = {
                "title": "Pin Eingabe",
                "label": "pin",
                "format": "Text",
        ...
        challenge = Challenge.from_dict(self.sut, data)
        self.assertTrue(isinstance(challenge, Challenge))
    
    def test_create_payment_proposal_from_dict(self):
        data = {
                "account_number": "DE67900900424711951500", 
                "bank_code": "DEMODE01", 
                "name": "Girokonto"
                }
        payment_proposal = PaymentProposal.from_dict(self.sut, data)
        self.assertTrue(isinstance(payment_proposal, PaymentProposal))
    ...
    def test_create_process_step_from_dict(self):
        data = {
                "options": {
                            "account_number": "100100100", 
                            "amount": 99, 
        ...
        process_step = ProcessStep.from_dict(self.sut, data)
        self.assertTrue(isinstance(process_step, ProcessStep))
    
    def test_create_process_options_from_dict(self):
        data = {
                "account_number": "100100100", 
                "amount": 99, 
                "bank_code": "82051000", 
        ...
        process_options = ProcessOptions.from_dict(self.sut, data)
        self.assertTrue(isinstance(process_options, ProcessOptions))
    
    def test_create_process_token_from_dict(self):
        data = {
                "task_token": "YmB-BtvbWufLnbwgAVfP7XfLatwhrtu0sATfnZNR7LGP-aLXiZ7BKzLdZI--EqEPnwh_h6mCxToLEBhtA7LVd4uM4gTcZG8F6UJs47g6kWJ0"
                }
        task_token = TaskToken.from_dict(self.sut, data)
    ...
    def test_create_security_from_dict(self):
        data = {
                "account_id": "A1.4", 
                "amount": 32.78, 
        ...
        security = Security.from_dict(self.sut, data)
